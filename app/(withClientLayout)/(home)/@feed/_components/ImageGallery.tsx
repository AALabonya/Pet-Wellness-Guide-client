...
//             key={idx}
//             alt={`Image ${idx + 1}`}
//             className="h-64 w-full object-fit rounded-lg transition-transform duration-200 hover:scale-105"
//             height={150}
//             src={image}
//             width={150}
//           />
...
//                   className="w-full h-auto object-fit rounded-lg transition-transform duration-200 hover:scale-105"
//                   height={200}
//                   src={image}
//                   width={300}
//                 />
  ...
  return (
    <div className="overflow-hidden">
      ...
      >
        {thumbnail.slice(0, 3).map((image, idx) => (
          <Image
            key={idx}
            alt={`Image ${idx + 1}`}
            className="h-72 w-full object-fit rounded-lg transition-transform duration-200 hover:scale-105"
            height={150}
            src={image}
            width={150}
          />
      ...
      {isModalOpen && (
        ...
        >
          <div className="bg-white p-4 rounded-lg max-w-3xl max-h-[90%] overflow-auto">
            <h2 className="text-xl font-bold mb-4 text-center text-black">All Images</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {thumbnail.map((image, idx) => (
                <Image
                  key={idx}
