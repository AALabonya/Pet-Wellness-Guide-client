        ...
        >
          ...
          <Input
            {...register("weight", { 
              ...
              max: { value: 100, message: "Weight must be less than or equal to 100 kg." }
            })}
            type="number"
      ...
      <div className="lg:w-1/2 w-full">
        <div className="grid grid-cols-2 gap-1 p-2 md:grid-cols-3 lg:grid-cols-2">
          ...
          <div
            ...
            style={{
              backgroundImage: 'url("https://img.freepik.com/premium-photo/happy-dog-posing-full-bowl-dry-food_695242-19744.jpg?w=1380")',
              height: '170px',
            }}
          ></div>
